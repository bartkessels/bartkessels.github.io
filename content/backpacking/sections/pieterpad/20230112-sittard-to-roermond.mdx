...
<ImageFloat
    image="/images/backpacking/pieterpad/sittard-to-roermond.jpg"
    imageSide="end"
    alt="This image is taken in Sittard near the Molenbeek (roughly translated, millstream)"
    height={200}>
