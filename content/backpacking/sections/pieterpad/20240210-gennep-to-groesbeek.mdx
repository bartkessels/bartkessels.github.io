---
slug: gennep-to-groesbeek
title: Gennep to Groesbeek
...
author: Bart Kessels
gpx: /gpx/pieterpad/gennep-to-groesbeek.gpx
date: 2023-08-16
weather: Mostly cloudy
temperatureC: 23
difficulty: moderate
tags: [Gennep, Milsbeek, Groesbeek]
---
...
<Intro>
    <Char>B</Char>efore we began, we thought that this was going to be the last leg of our vacation. Little did we wouldn't be able to complete this leg.
</Intro>

## The leg

<ImageFloat
    image="/images/backpacking/pieterpad/gennep-to-groesbeek.jpg"
    imageSide="end"
    caption="This image is taken near Milsbeek looking at the treeline of the Sint Jansberg (saint Jan mountain)."
    height={200}>

    The last leg of our vacation started in Ven-Zelderheide because of some troubles we had with the camping, as you can read in the [previous post](./20230814-vierlingsbeek-to-gennep.mdx). This isn't captured in the route because it was a last-minute decision.
