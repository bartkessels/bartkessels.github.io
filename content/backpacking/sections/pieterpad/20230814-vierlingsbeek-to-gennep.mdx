---
slug: vierlingsbeek-to-gennep
title: Vierlingsbeek to Gennep
...
author: Bart Kessels
gpx: /gpx/pieterpad/vierlingsbeek-to-gennep.gpx
image: /images/backpacking/pieterpad/vierlingsbeek-to-gennep.jpg
caption: This image is taken in Gennep at the east side of the town.
date: 2023-08-14
weather: Clear skies
temperatureC: 26
difficulty: moderate
tags: [Vierlingsbeek, Afferden, Gennep]
---

import ImageFloat from '@/components/ImageFloat.astro';

After a [coffee and a good talk](./20230812-swolgen-to-vierlingsbeek.mdx) we were all ready to go. This was a nice start that we haven't had in quite some time, a cup of coffee at the break of dawn. Usually we had to walk a couple of miles before our first cup, so unlike at home we didn't take this for granted but really appreciated the moment.
...
<ImageFloat
    image="/images/backpacking/pieterpad/vierlingsbeek-to-gennep.jpg"
    imageSide="end"
    alt="This image is taken in Gennep at the east side of the town."
    height={200}>
