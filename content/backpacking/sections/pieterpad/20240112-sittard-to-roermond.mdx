---
slug: sittard-to-roermond
title: Sittard to Roermond
...
author: Bart Kessels
gpx: /gpx/pieterpad/sittard-to-roermond.gpx
date: 2023-04-12
weather: Foggy with some sunshine
temperatureC: 15
difficulty: easy
tags: [Sittard, Echt-Susteren, Montfort, Roermond]
---
...
<Intro>
    <Char>W</Char>e wanted to test our newly bought gear before heading off to Sweden to go backpacking in the wilderness. Therefore we decided to walk the most well-known trail in the Netherlands.
</Intro>

During april in 2023, my girlfriend and I decided to start walking the Pieterpad. See the [previous post](../../trails/20230707-pieterpad.mdx) for more information about the Pieterpad. We've decided to walk the Pieterpad here in the Netherlands because for us, it's near-by, and there are a lot of camping's were we can stay for the night.

## The leg

<ImageFloat
    image="/images/backpacking/pieterpad/sittard-to-roermond.jpg"
    imageSide="end"
...
Because the last day consists of half a leg from the Pieterpad, the end was in the middle of nowhere. So we had to leave the trail and walk straight to the train station in Roermond to get back to Venlo. When walking to the train station, we walked through the city, and I remember a lot of people looking at us if they were thinking _'what are they doing?'_. We looked exhausted, sweaty and dirty and walked without a coat while it was only around 12&deg; Celsius (53,9&deg; Fahrenheit) while everyone else was walking around with heavy winter clothes.
