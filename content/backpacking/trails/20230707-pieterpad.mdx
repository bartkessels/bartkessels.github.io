...
date: 2023-07-07
image: /images/backpacking/pieterpad/introduction.jpg
caption: This image is taken in Sevenum near Het Schuitwater (roughly translated, The barge water)
country: "Netherlands"
location: "Pieterburen - Sint Pietersberg"
distanceKm: 500
totalSections: 26
tags: [Long distance trail, Netherlands]
sections:
  - sittard-to-roermond
  - swalmen-to-venlo
  - venlo-to-swolgen
...
<Intro>
    <Char>F</Char>or the non-Dutch people it might not sound familiar, “het Pieterpad”, but in the Netherlands it's one of the most well known long distance trails that has been laid out [(Stichting Pieterpad, n.d.)](https://www.pieterpad.nl/pieterpad/introductie). And we're going to walk all of it!
</Intro>
