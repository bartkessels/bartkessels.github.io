---
slug: change-executable-bit-windows
...
author: Bart Kessels
image: /images/blog/miscellaneous/change-executable-bit-windows.png
...
So, let's dive into the permissions on Unix-like systems and see where this error message comes from and how to fix this. For the purpose of having a single truth, everything in this blog post is steered towards Linux. This might be true for other Unix-like systems, but that's not in the scope of this blog post.
