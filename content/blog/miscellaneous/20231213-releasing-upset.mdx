...
author: Bart Kessels
date: 2023-12-13
image: /images/blog/miscellaneous/releasing-upset.png
...
<Intro>
    <Char>I</Char>n the last couple of weeks I've had a bit of a rough patch with my work laptop. Which lead me to installing it over and over again. As a developer I obviously had to come up with some sort of automated fix for this.
</Intro>
...
If you're an open source fanatic as well, and love to dig a little into Rust I'd like to invite you to contribute to Upset. This can either be trough code-reviews, adding a feature you'd like
