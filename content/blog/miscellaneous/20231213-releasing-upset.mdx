...
description: I've been struggling with my work laptop which meant that I had to reinstall everything a couple of times. So, of course I wrote an application to automate this process.
author: Bart Kessels
date: 2023-12-13
...
If you're an open source fanatic as well, and love to dig a little into Rust I'd like to invite you to contribute to Upset. This can either be through code-reviews, adding a feature you'd like
