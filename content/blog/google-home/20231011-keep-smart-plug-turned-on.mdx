...
That evening the same happened, we turn off all the lights and hear the clicking noise again. We knew that noise was probably the smart plug so we also ask Google to turn on the smart plug and all was well. At least, for that evening.
