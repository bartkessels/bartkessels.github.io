---
slug: keep-your-smart-plug-turned-on
...
author: Bart Kessels
date: 2023-10-11
image: /images/blog/google-home/keep-smart-plug-turned-on.png
...
<Intro>
    <Char>A</Char> couple of weeks back we bought a Philips smart plug, so we can turn on and off the phone chargers when we're in bed. Our idea was that when we're out of bed or not at home, those chargers don't need to be on all the time. And what better way to do this than to use a smart plug.
</Intro>
...
That evening the same happened, we turn off all the lights and hear that clicking noise again. We knew that the noise was probably the smart plug so we also ask Google to turn on the smart plug and all was well. At least, for that evening.
