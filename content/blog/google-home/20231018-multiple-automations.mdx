---
slug: keep-your-automation-clean
title: Keep your automation clean
description: Keep your automation overview clean by adding multiple automations in the same yaml-file.
author: Bart Kessels
date: 2023-10-18
image: /images/blog/google-home/multiple-automations.png
...
Since Google has introduced their new [automation](https://home.google.com/the-latest/) tool, I've been moving everything back from Siri Shortcuts to the Google Home ecosystem. After adding all the automation steps one by one, the overview was completely gone. We had more than twenty automation steps all with different names and different starters. When an automation wasn't working properly, for example the lights would "flash" bright and then turn to a brightness of 70%, I had to search in the overview for the correct automation steps and then guess which one was the cause of the problem.
