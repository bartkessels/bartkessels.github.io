...
<Intro>
    <Char>W</Char>hen agents are building most of our software, we need to find a way to properly validate the code they write. But can we trust the validated code if agents also write the unit tests to validate the code?
</Intro>
