...
<Intro>
    <Char>W</Char>ith the release of [_It Depends_](../../software/it-depends.mdx), I've been searching for a way to execute a command after a target has been built. The reason for this is that I'd like to have a flag which will trigger the `macdeployqt` application on the generated app bundle.
</Intro>
