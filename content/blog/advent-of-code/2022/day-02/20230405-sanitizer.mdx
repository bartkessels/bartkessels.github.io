---
slug: 2022/day-two/sanitizer
title: AoC 2022, Day two - Sanitizer
...
<CodeBlock filename="aoc-2022/day2/src/main/kotlin/aoc/Sanitizer.kt">
```kotlin
class Sanitizer(
...
<CodeBlock filename="aoc-2022/day2/src/test/kotlin/aoc/SanitizerTest.kt">
```kotlin
class SanitizerTest {
    @Test
    fun testGetItems() {
