---
slug: 2022/day-two/part-one
title: AoC 2022, Day two - Part One
description: Get the outcome of each rock-paper-scissors match.
author: Bart Kessels
date: 2023-04-12
image: /images/blog/advent-of-code/2022/day-2.png
...
Now that we have the following data structure from our [previous post](./20230405-sanitizer.mdx), we can start by implementing the business logic to calculate the
...
<CodeBlock filename="aoc-2022/day2/src/main/kotlin/aoc/PartOne.kt">
```kotlin
class PartOne(
...
up by splitting it into a separate method or normalizing the data into `Rock`, `Paper` and `Scissors` instead of the current `A`, `B`, `X` etc.
...
<CodeBlock filename="aoc-2022/day2/src/test/kotlin/aoc/PartOne.kt">
```kotlin
class PartOneTest {
    @Test
    fun testGetResult() {
