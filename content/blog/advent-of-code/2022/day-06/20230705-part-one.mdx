---
slug: 2022/day-six/part-one
title: AoC 2022, Day six - Part One
...
Now that we have the following data structure from our [previous post](./20230628-sanitizer.mdx), we can create the logic to retrieve the  start of the packet marker.
...
<CodeBlock filename="aoc-2022/day6/src/main/kotlin/aoc/PartOne.kt">
```kotlin
class PartOne(
...
<CodeBlock filename="aoc-2022/day6/src/test/kotlin/aoc/PartOne.kt">
```kotlin
class PartOneTest {
    @Test
