---
slug: 2022/day-six/part-two
title: AoC 2022, Day six - Part Two
...
<CodeBlock filename="aoc-2022/day6/src/main/kotlin/aoc/PartTwo.kt">
```kotlin
class PartTwo(
...
<CodeBlock filename="aoc-2022/day6/src/test/kotlin/aoc/PartTwo.kt">
```kotlin
class PartTwoTest {
    @Test
