---
slug: 2022/day-four/part-two
title: AoC 2022, Day four - Part Two
...
In this part of the advent of code, we need to check if two ranges overlap at all. So we can take the code from our [previous part](./20230524-part-one.mdx) and change a couple of lines.
...
Let's take a look at our design from the [previous post](./20230524-part-one.mdx).
...
<CodeBlock filename="aoc-2022/day4/src/main/kotlin/aoc/PartTwo.kt">
```kotlin
class PartTwo(
...
<CodeBlock filename="aoc-2022/day4/src/test/kotlin/aoc/PartTwo.kt">
```kotlin
class PartTwoTest {
    @Test
    fun testGetResult() {
