---
slug: 2022/day-four/sanitizer
title: AoC 2022, Day four - Sanitizer
...
<CodeBlock filename="aoc-2022/day4/src/main/kotlin/aoc/Sanitizer.kt">
```kotlin
class Sanitizer(
...
<CodeBlock filename="aoc-2022/day4/src/test/kotlin/aoc/SanitizerTest.kt">
```kotlin
class SanitizerTest {
    @Test
    fun testGetItems() {
