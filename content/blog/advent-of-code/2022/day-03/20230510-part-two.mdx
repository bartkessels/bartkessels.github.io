---
slug: 2022/day-three/part-two
title: AoC 2022, Day three - Part Two
...
So now that we have our rucksacks with each compartment separated, we can think about how we want to setup our business logic. For this part we need to identify the matching character that's present in the three concurrent backpacks.
...
<CodeBlock filename="aoc-2022/day3/src/main/kotlin/aoc/PartTwo.kt">
```kotlin
class PartTwo(
...
<CodeBlock filename="aoc-2022/day3/src/test/kotlin/aoc/PartTwo.kt">
```kotlin
class PartTwoTest {
    @Test
    fun testGetResult() {
