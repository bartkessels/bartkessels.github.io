---
slug: 2022/day-three/sanitizer
title: AoC 2022, Day three - Sanitizer
...
<CodeBlock filename="aoc-2022/day3/src/main/kotlin/aoc/Sanitizer.kt">
```kotlin
class Sanitizer(
...
<CodeBlock filename="aoc-2022/day3/src/test/kotlin/aoc/SanitizerTest.kt">
```kotlin
class SanitizerTest {
    @Test
    fun testGetItems() {
