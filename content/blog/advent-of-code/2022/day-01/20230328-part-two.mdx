---
slug: 2022/day-one/part-two
title: AoC 2022, Day one - Part Two
...
Now that we have the following data structure from our [previous post](./20230314-sanitizer.mdx), we started implementing the business logic to retrieve the three highest combined
...
<CodeBlock filename="aoc-2022/day1/src/main/kotlin/aoc/PartTwo.kt">
```kotlin
class PartTwo(
...
<CodeBlock filename="aoc-2022/day1/src/test/kotlin/aoc/PartTwoTest.kt">
```kotlin
class PartTwoTest {
    @Test
    fun testGetResult() {
