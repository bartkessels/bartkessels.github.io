---
slug: 2022/day-one/part-one
title: AoC 2022, Day one - Part One
description: "Count the calories that each elve is carrying"
author: Bart Kessels
date: 2023-03-21
image: /images/blog/advent-of-code/2022/day-1.png
...
Now that we have the following data structure from our [previous post](./20230314-sanitizer.mdx), we start implementing the business logic to retrieve the highest combined number of calories.

<CodeBlock filename="Elve structure">
```kotlin
[
...
<CodeBlock filename="aoc-2022/day1/src/main/kotlin/aoc/PartOne.kt">
```kotlin
class PartOne(
...
<CodeBlock filename="aoc-2022/day1/src/test/kotlin/aoc/PartOneTest.kt">
```kotlin
class PartOneTest {
    @Test
    fun testGetResult() {
