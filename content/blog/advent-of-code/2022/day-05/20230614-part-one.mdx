---
slug: 2022/day-five/part-one
title: AoC 2022, Day five - Part One
...
Now that we have the following data structure from our [previous post](./20230607-sanitizer.mdx), we can start thinking about how we can execute the commands to fill up the stacks.
...
<CodeBlock filename="aoc-2022/day5/src/main/kotlin/aoc/PartOne.kt">
```kotlin
class PartOne(
...
<CodeBlock filename="aoc-2022/day5/src/test/kotlin/aoc/PartOne.kt">
```kotlin
class PartOneTest {
    @Test
    fun testGetResult() {
