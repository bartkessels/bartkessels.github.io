---
slug: create-an-android-app/set-up-jetpack-compose
...
author: Bart Kessels
date: 2024-02-21
image: /images/blog/android/create-an-application/set-up-jetpack-compose.png
...
Now that we have our [base project set up](../../../stories/20240214-create-an-android-app.mdx), let's add an activity with a view, so we can see our own application. When building Android application in this time and age, it's pretty assumable that you're going to use Jetpack Compose for your UI, since it's also the recommended toolkit by Google [(Google, n.d.)](https://developer.android.com/jetpack/compose).
...
<CodeBlock filename="app/AndroidManifest.xml">
```xml
<activity
...
![Our basic Android app](/images/blog/android/create-an-application/basic-android-application.png)
