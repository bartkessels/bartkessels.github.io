---
slug: create-an-android-app/support-multiple-languages
...
author: Bart Kessels
date: 2024-03-13
image: /images/blog/android/create-an-application/support-multiple-languages.png
...
<Intro>
    <Char>I</Char>n our [previous post](./20240306-set-up-material-design.mdx) we've updated the app to use Material Design. But the text we display is hard-coded in our app. What if our user base consists of English-speaking users and Dutch-speaking users, we definitely want them to use our app in their native language.
</Intro>
...
<CodeBlock filename="app/src/main/**/res/values/strings.xml">
...
<CodeBlock filename="app/src/main/**/main.kt">
...
![Supporting the Dutch language](/images/blog/android/create-an-application/adding-the-dutch-language.png)
