...
In our [previous post](./20240306-set-up-material-design.mdx) we've updated the app to use Material Design. But the text we display is hard-coded in our app. What if our user base consists of English-speaking users and Dutch-speaking users, we'd probably want them to use our app in their native language.
