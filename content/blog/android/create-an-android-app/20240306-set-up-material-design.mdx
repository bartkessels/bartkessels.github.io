---
slug: create-an-android-app/set-up-material-design
...
author: Bart Kessels
date: 2024-03-06
image: /images/blog/android/create-an-application/set-up-material-design.png
...
<Intro>
    <Char>N</Char>ow that we have decoupled our UI from the logic, it's time to do something about the look and feel of our app. Right now it's an ugly app with just some basic text on a white background.
</Intro>
...
<CodeBlock filename="app/src/main/AndroidManifest.xml">
...
![Our basic Android App with Material Design](/images/blog/android/create-an-application/basic-android-application-material-design.png)
