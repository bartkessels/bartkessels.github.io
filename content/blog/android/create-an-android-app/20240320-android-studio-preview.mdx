---
slug: create-an-android-app/enable-android-studio-preview
...
author: Bart Kessels
date: 2024-03-20
image: /images/blog/android/create-an-application/android-studio-preview.png
...
<Intro>
    <Char>I</Char>n our previous posts about [setting up Jetpack Compose](./20240221-set-up-jetpack-compose.mdx) and [setting up Material Design](./20240306-set-up-material-design.mdx) we've been through two UI iterations. To see each iteration, we had to build and run our app. There is a way to properly preview the UI. 
</Intro>

This workflow isn't that bad for just two iterations and our small UI, but let's say your working on a big project which consists of multiple components where you'd like to see each component separate from the entire app. This might become pretty tedious when you have to build your entire app just to see how a little component looks.
...
<CodeBlock filename="src/main/kotlin/**/main.kt">
...
![Android Studio with code and the preview](/images/blog/android/create-an-application/android-studio-code-with-preview.png)
