...
<Intro>
    <Char>M</Char>y expectations for this is, that when combined with the [primary constructor](./20231227-primary-constructor.mdx) it can be used to declare readonly fields in a class that are injected through the constructor. But let's find out if that's the case.
</Intro>
