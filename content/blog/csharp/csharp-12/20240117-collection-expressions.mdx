...
description: C# 12 finally introduces some new syntactical sugar that I'm eager to use in production because it improves the readability of the code.
author: Bart Kessels
date: 2024-01-17
...
Just like the previous initialization of a list, it de-sugars the code into the following example.
