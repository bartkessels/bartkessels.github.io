---
slug: csharp-12/collection-expressions
...
author: Bart Kessels
date: 2024-01-17
image: /images/blog/c-sharp/c-sharp-12/collection-expressions.png
...
<Intro>
    <Char>W</Char>hen reading through the [what's new in C# 12](https://learn.microsoft.com/en-us/dotnet/csharp/whats-new/csharp-12) post from Microsoft I was really happy when I saw _'Collection expressions`_. Because at work we use both C# and Kotlin, and initializing a list with a default set of values in Kotlin looks a lot cleaner to me than the current C# initialization does.
</Intro>
...
If you remember the previous post about [default lambda parameters](./20240110-default-lambda-parameters.mdx), we created a list of names using the 'old' syntax like this.
