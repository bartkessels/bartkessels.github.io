...
author: Bart Kessels
date: 2023-12-20
image: /images/blog/c-sharp/c-sharp-12/introduction.png
caption: This image is generated using Dall-E
subject: csharp
tags: [.NET, Microsoft, C#, C# 12]
featured: true
posts:
    - csharp-12/primary-constructor
    - csharp-12/ref-readonly
    - csharp-12/default-lambda-parameters
    - csharp-12/collection-expressions
---
...
<Intro>
    <Char>A</Char> couple of weeks ago Microsoft has launched C# 12 which packed a lot of new features [(Microsoft, 2023)](https://learn.microsoft.com/en-us/dotnet/csharp/whats-new/csharp-12), which we should obviously try-out!
</Intro>
...
_*Note_ the `@8` is not required since the latest version of the formula is already _8_. But for repeatability, I've included it.
