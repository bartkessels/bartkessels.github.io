...
author: Bart Kessels
date: 2024-02-14
image: /images/blog/android/create-an-application/create-an-android-app.png
caption: This image is generated using Dall-E
subject: android
tags: [Android, App Development]
featured: true
posts:
    - create-an-android-app/set-up-jetpack-compose
    - create-an-android-app/set-up-view-models-with-jetpack-compose
    - create-an-android-app/set-up-material-design
    - create-an-android-app/support-multiple-languages
    - create-an-android-app/enable-android-studio-preview
    - create-an-android-app/automatically-test-android-ui
---
...
<Intro>
    <Char>H</Char>ave you ever had the urge to build your own Android app? Well, I have, and it's not as hard as it might sound at first.
</Intro>
